...
<section class="content">
    <div class="form-group text-right">
        <a href="{{$routes['index']}}" class="btn btn-sm btn-outline-info float-left">
            <i class="fa fa-arrow-circle-left"></i> @lang('app.back')
        </a>
        <a href="{{route('invoices.edit', $invoice->uuid)}}" class="btn btn-warning btn-sm mb-1">
            <span class="btn-label"><i class="fa fa-edit"></i> @lang('app.edit')</span>
        </a>
        <a href="{{route('invoice_pdf',$invoice->uuid)}}" class="btn btn-primary btn-sm mb-1" target="_blank">
            <span class="btn-label"><i class="fa fa-download"></i> @lang('app.download')</span>
        </a>
        <a data-toggle="ajax-modal" href="{{route('invoice.send_modal',$invoice->uuid)}}" class="btn btn-success btn-sm mb-1">
