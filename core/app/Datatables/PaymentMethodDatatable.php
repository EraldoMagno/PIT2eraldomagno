...
class PaymentMethodDatatable extends CoreDatatable
{
    protected $editRoute = 'settings.payment.edit';
    protected $deleteRoute = 'settings.payment.destroy';
    ...
    {
        $this->edit_permission = hasPermission('edit_payment_method');
        $this->delete_permission = hasPermission('delete_payment_method');
    }
