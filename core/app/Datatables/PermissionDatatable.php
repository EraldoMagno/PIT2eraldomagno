...
class PermissionDatatable extends CoreDatatable
{
    protected $editRoute = 'settings.permission.edit';
    protected $deleteRoute = 'settings.permission.destroy';
    ...
    {
        $this->edit_permission = hasPermission('edit_permission');
        $this->delete_permission = hasPermission('delete_permission');
    }
